...
Let's say we are interested in a single biological process: melanin biosynthesis. Conveniently, a GO term for this exists: [GO:0042438](https://www.ebi.ac.uk/QuickGO/term/GO:0042438), as well as a _Xenopus_-specific Reactome pathway [R-XTR-5662702](https://reactome.org/content/detail/R-XTR-5662702). Essentially, what we want to do is see how many of our differentially expressed genes are either part of this term or not. This would result in a contingency table like this:
